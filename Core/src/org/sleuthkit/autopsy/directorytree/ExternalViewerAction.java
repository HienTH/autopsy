...
public class ExternalViewerAction extends AbstractAction {
     ...
     */
    @Messages({
        "ExternalViewerAction.actionPerformed.failure.title=Không thể mở tệp tin",
        "ExternalViewerAction.actionPerformed.failure.IO.message=Không có trình soạn thảo liên quan cho tệp kiểu này hoặc ứng dụng liên quan không khởi chạy.",
        "ExternalViewerAction.actionPerformed.failure.support.message=Nền tảng này (hệ điều hành) không hỗ trợ mở một tệp trong trình soạn thảo theo cách này.",
        "ExternalViewerAction.actionPerformed.failure.missingFile.message=Tệp không còn tồn tại.",
        "ExternalViewerAction.actionPerformed.failure.permission.message=Quyền để mở tệp đã bị từ chối."})
