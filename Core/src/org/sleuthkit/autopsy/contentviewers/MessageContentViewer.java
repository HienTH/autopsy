...
public class MessageContentViewer extends javax.swing.JPanel implements DataContentViewer {
     ...
     */
    @NbBundle.Messages("MessageContentViewer.AtrachmentsPanel.title=Tệp đính kèm")
    ...
    @NbBundle.Messages({
        "MessageContentViewer.showImagesToggleButton.hide.text=Ẩn ảnh",
        "MessageContentViewer.showImagesToggleButton.text=Hiển thị hình ảnh"})
    ...
    @Override
    @NbBundle.Messages("MessageContentViewer.title=Thông báo")
    public String getTitle() {
        return Bundle.MessageContentViewer_title();
    }

    @Override
    @NbBundle.Messages("MessageContentViewer.toolTip=Hiển thị thông báo.")
