...
class CaseInformationPanel extends javax.swing.JPanel {
    ...
    @Messages({
        "CaseInformationPanel.caseDetails.header=Chi tiết",
        "CaseInformationPanel.ingestJobInfo.header=Lịch sử nhập",
        "CaseInformationPanel.editDetailsButton.text=Chỉnh sửa chi tiết",
        "CaseInformationPanel.editDetailsDialog.title=Chỉnh sửa chi tiết hồ sơ"
    })
