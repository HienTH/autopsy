...
final class ShowInTimelineDialog extends Dialog<ViewInTimelineRequestedEvent> {
    ...
    @NbBundle.Messages({"ShowInTimelineDialog.showTimelineButtonType.text=Hiển thị Dòng thời gian"})
     ...
     */
    @NbBundle.Messages({
        "ShowInTimelineDialog.amountValidator.message=Nội dung đã nhập chỉ có thể chứa số."
    })
     ...
     */
    @NbBundle.Messages({"ShowInTimelineDialog.artifactTitle=Xem kết quả trong Dòng sự kiện."})
    ...
    @NbBundle.Messages({"# {0} - file path",
        "ShowInTimelineDialog.fileTitle=Xem {0} trong dòng sự kiện.",
        "ShowInTimelineDialog.eventSelectionValidator.message=Bạn phải chọn một sự kiện."})
