...
public final class CreateLiveTriageDriveAction extends CallableSystemAction implements PropertyChangeListener {
    ...
    @NbBundle.Messages({"CreateLiveTriageDriveAction.error.title=Lỗi khi tạo đĩa triage trực tiếp",
        "CreateLiveTriageDriveAction.exenotfound.message=Không thể tìm thấy phần thực thi",
        "CreateLiveTriageDriveAction.batchFileError.message=Lỗi khi tạo tệp hàng loạt",
        "CreateLiveTriageDriveAction.appPathError.message=Không thể định vị thư mục ứng dụng",
        "CreateLiveTriageDriveAction.copyError.message=Không thể sao chép ứng dụng. Chỉ hoạt động trên phiên bản đã cài đặt.",
        "CreateLiveTriageDriveAction.success.title=Thành công",
        "CreateLiveTriageDriveAction.success.message=Đã tạo phân vùng động trực tiếp. Sử dụng RunFromUSB.bat để chạy ứng dụng"
    })
    @Override
    ...
    @NbBundle.Messages({"# {0} - drivePath",
        "CreateLiveTriageDriveAction.progressBar.text=Sao chép tệp tin lưu trữ trực tiếp sang {0}",
        "CreateLiveTriageDriveAction.progressBar.title=Vui lòng đợi"})
    @Override
    ...
    private class CopyFilesWorker extends SwingWorker<Void, Void> {
        ...
        @NbBundle.Messages({"CopyFilesWorker.error.text=Lỗi khi sao chép các tập tin triage trực tiếp",
            "CopyFilesWorker.done.text=Đã hoàn thành tạo đĩa triage trực tiếp"})
        @Override
        protected void done() {
            try {
                super.get();
