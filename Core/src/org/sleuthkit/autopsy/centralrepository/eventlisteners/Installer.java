...
public class Installer extends ModuleInstall {
    ...
    @NbBundle.Messages({"Installer.centralRepoUpgradeFailed.title=Nâng cấp kho trung tâm không thành công",
        "Installer.centralRepoUpgradeFailed.message=Không thể nâng cấp kho trung tâm. Nó đã bị vô hiệu hóa."
    })
    @Override
