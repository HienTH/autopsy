...
@Messages({"GetTagNameDialog.descriptionLabel.text=Mô tả:",
    "GetTagNameDialog.notableCheckbox.text=Thẻ cho biết mục tin  là đáng chú ý."})
public class GetTagNameDialog extends JDialog {
    ...
    @NbBundle.Messages({"GetTagNameDialog.tagNameAlreadyExists.message=Tên thẻ phải là duy nhất. Thẻ có tên này đã tồn tại.",
        "GetTagNameDialog.tagNameAlreadyExists.title=Tên thẻ trùng lặp",
        "GetTagNameDialog.tagDescriptionIllegalCharacters.message=Mô tả thẻ không được chứa dấu phẩy (,) hoặc dấu chấm phẩy (;)",
        "GetTagNameDialog.tagDescriptionIllegalCharacters.title=Ký tự không hợp lệ trong thẻ mô tả"})
