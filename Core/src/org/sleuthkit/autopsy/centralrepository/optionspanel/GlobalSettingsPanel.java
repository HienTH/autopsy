...
public final class GlobalSettingsPanel extends IngestModuleGlobalSettingsPanel implements OptionsPanel {
    ...
    @Messages({"GlobalSettingsPanel.title=Cài đặt Kho Trung tâm",
        "GlobalSettingsPanel.cbUseCentralRepo.text=Sử dụng kho trung tâm",
        "GlobalSettingsPanel.pnTagManagement.border.title=Thẻ",
        "GlobalSettingsPanel.pnCorrelationProperties.border.title=Thuộc tính tương quan",
        "GlobalSettingsPanel.lbCentralRepository.text=Một kho trung tâm cho phép bạn kiểm tra tương quan các tập tin và kết quả giữa các hồ sơ.",
        "GlobalSettingsPanel.manageTagsTextArea.text=Định cấu hình các tên thẻ nào được liên kết với các mục đáng chú ý. "
        + "Khi các thẻ này được sử dụng, tập tin hoặc kết quả sẽ được ghi lại trong kho trung tâm. "
        + "Nếu tệp hoặc kết quả đó được xem lại trong các hồ sơ trong tương lai, nó sẽ bị gắn cờ.",
        "GlobalSettingsPanel.correlationPropertiesTextArea.text=Chọn tệp và thuộc tính kết quả để lưu trữ trong kho trung tâm cho các tương thích sau.",
        "GlobalSettingsPanel.organizationPanel.border.title=Tổ chức",
        "GlobalSettingsPanel.manageOrganizationButton.text=Quản lý tổ chức",
        "GlobalSettingsPanel.organizationTextArea.text=Thông tin về tổ chức có thể được theo dõi trong kho trung tâm"
    })
    ...
    @Messages({"GlobalSettingsPanel.updateFailed.title=Cập nhật không thành công",
               "GlobalSettingsPanel.updateFailed.message=Không thể cập nhật cơ sở dữ liệu. Kho trung tâm đã bị tắt."
    })
    ...
    @Override
    @Messages({"GlobalSettingsPanel.validationerrMsg.mustConfigure=Cấu hình cơ sở dữ liệu để kích hoạt module này."})
    public void load() {
        tbOops.setText("");
    ...
    @Messages({"GlobalSettingsPanel.validationErrMsg.ingestRunning=Bạn không thể thay đổi cài đặt khi đang điều tra."})
