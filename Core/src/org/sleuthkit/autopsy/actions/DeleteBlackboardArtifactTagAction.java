 ...
 */
@NbBundle.Messages({
    "DeleteBlackboardArtifactTagAction.deleteTag=Xóa thẻ",
    "# {0} - tagName",
    "DeleteBlackboardArtifactTagAction.unableToDelTag.msg=Không thể xóa thẻ {0}.",
    "DeleteBlackboardArtifactTagAction.tagDelErr=Lỗi xóa thẻ"
})
