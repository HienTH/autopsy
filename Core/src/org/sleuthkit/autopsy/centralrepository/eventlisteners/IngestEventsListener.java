...
public class IngestEventsListener {
    ...
    @NbBundle.Messages({"IngestEventsListener.prevTaggedSet.text=Thẻ được gắn trước đó không sẵn sàng (Kho trung tâm)",
        "IngestEventsListener.prevCaseComment.text=Hồ sơ trước: ",
        "IngestEventsListener.ingestmodule.name=Phương tiện tương quan"})
