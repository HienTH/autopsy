...
public final class IngestJobInfoPanel extends javax.swing.JPanel {
    ...
    @Messages({"IngestJobInfoPanel.loadIngestJob.error.text=Không tải được các công việc điều tra.",
        "IngestJobInfoPanel.loadIngestJob.error.title=Không thể tải"})
    ...
    @Messages({"IngestJobInfoPanel.IngestJobTableModel.DataSource.header=Nguồn dữ liệu",
        "IngestJobInfoPanel.IngestJobTableModel.StartTime.header=Thời gian bắt đầu",
        "IngestJobInfoPanel.IngestJobTableModel.EndTime.header=Thời gian kết thúc",
        "IngestJobInfoPanel.IngestJobTableModel.IngestStatus.header=Trạng thái điều tra"})
    ...
    @Messages({"IngestJobInfoPanel.IngestModuleTableModel.ModuleName.header=Tên Module",
        "IngestJobInfoPanel.IngestModuleTableModel.ModuleVersion.header=Phiên bản Module"})
