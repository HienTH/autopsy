...
final class CasePropertiesPanel extends javax.swing.JPanel {
    ...
    @Messages({"CasePropertiesPanel.casePanel.border.title=Hồ sơ",
        "CasePropertiesPanel.lbCaseUUIDLabel.text=UUID Hồ sơ:",
        "CasePropertiesPanel.examinerPanel.border.title=Điều tra viên",
        "CasePropertiesPanel.examinerLabel.text=Tên:",
        "CasePropertiesPanel.lbExaminerPhoneLabel.text=Điện thoại:",
        "CasePropertiesPanel.lbExaminerEmailLabel.text=Email:",
        "CasePropertiesPanel.lbNotesLabel.text=Ghi chú:",
        "CasePropertiesPanel.pnOrganization.border.title=Cơ quan",
        "CasePropertiesPanel.lbOrganizationNameLabel.text=Tên:",
        "CasePropertiesPanel.lbPointOfContactNameLabel.text=Điểm liên hệ:",
        "CasePropertiesPanel.lbPointOfContactPhoneLabel.text=Điện thoại:",
