...
class SizeSearchFilter extends AbstractFileSearchFilter<SizeSearchPanel> {
    ...
    @Override
    @Messages ({
        "SizeSearchFilter.errorMessage.nonNegativeNumber=Kích thước đầu vào là một số âm.",
        "SizeSearchFilter.errorMessage.notANumber=Kích thước đầu vào không phải là số."
    })
