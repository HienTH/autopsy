...
public final class OpenTimelineAction extends CallableSystemAction {
    ...
    @NbBundle.Messages({
        "OpenTimelineAction.settingsErrorMessage=Không thể khởi tạo cài đặt dòng thời gian.",
        "OpenTimeLineAction.msgdlg.text=Không thể tạo thời gian, không có nguồn dữ liệu."})
    ...
    @Override
    @NbBundle.Messages("OpenTimelineAction.displayName=Dòng sự kiện")
