...
public class Installer extends ModuleInstall {
    ...
    @NbBundle.Messages({
        "Installer.closing.confirmationDialog.title=Đang chạy điều tra",
        "Installer.closing.confirmationDialog.message=Đang chạy điều tra, có chắc bạn muốn thoát?",
        "# {0} - exception message", "Installer.closing.messageBox.caseCloseExceptionMessage=Lỗi khi kết thúc hồ sơ: {0}"
    })
    @Override
