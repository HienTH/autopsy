 ...
 * @author root
 */
public class DocumentCheckModule implements FileIngestModule{
        ...
        */
        ...
        try {
                        ...
                        && DetectDocument.Detect(file))
            {
                ...
                ModuleDataEvent event = new ModuleDataEvent(DocumentCheckModuleFactory.getModuleName(), BlackboardArtifact.ARTIFACT_TYPE.TSK_GEN_INFO);     
    ...
    synchronized static void reportBlackboardPostCount(long ingestJobId) {
        ...
        if (refCount == 0) {
            ...
            IngestMessage message = IngestMessage.createMessage(
                    ...
                    DocumentCheckModuleFactory.getModuleName(),
                    msgText);
