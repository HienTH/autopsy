...
public class DataContentViewerOtherCasesTableModel extends AbstractTableModel {
    ...
    @Messages({"DataContentViewerOtherCasesTableModel.case=Hồ sơ",
        "DataContentViewerOtherCasesTableModel.device=Thiết bị",
        "DataContentViewerOtherCasesTableModel.dataSource=Nguồn dữ liệu",
        "DataContentViewerOtherCasesTableModel.path=Đường dẫn",
        "DataContentViewerOtherCasesTableModel.type=Loại tương quan",
        "DataContentViewerOtherCasesTableModel.value=Giá trị tương quan",
        "DataContentViewerOtherCasesTableModel.known=Gắn thẻ",
        "DataContentViewerOtherCasesTableModel.comment=Bình luận",
        "DataContentViewerOtherCasesTableModel.noData=Không có dữ liệu.",})
    enum TableColumns {
