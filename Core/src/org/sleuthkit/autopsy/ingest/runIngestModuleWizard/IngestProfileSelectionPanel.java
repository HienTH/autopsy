...
final class IngestProfileSelectionPanel extends JPanel {
    ...
    @Messages({"IngestProfileSelectionPanel.customSettings.name=Cài đặt Tuỳ chỉnh",
        "IngestProfileSelectionPanel.customSettings.description=cấu hình cài đặt module trong bước tiếp theo của trình hướng dẫn"})
