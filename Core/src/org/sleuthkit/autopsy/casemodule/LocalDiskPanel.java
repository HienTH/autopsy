...
@NbBundle.Messages({"LocalDiskPanel.refreshTablebutton.text=Làm mới ổ đĩa địa phương"
})
/**
...
final class LocalDiskPanel extends JPanel {
    ...
    private class LocalDiskModel implements TableModel {
        ...
        @NbBundle.Messages({"LocalDiskPanel.diskTable.column1.title=Tên ổ đĩa",
            "LocalDiskPanel.diskTable.column2.title=Kích thước ổ đĩa"
        })
