...
public class VirtualDirectoryNode extends SpecialDirectoryNode {
    ...
    @NbBundle.Messages({"VirtualDirectoryNode.createSheet.size.name=Size (Bytes)",
        "VirtualDirectoryNode.createSheet.size.displayName=Kích thước (Bytes)",
        "VirtualDirectoryNode.createSheet.size.desc=Kích thước của nguồn dữ liệu theo byte.",
        "VirtualDirectoryNode.createSheet.type.name=Type",
        "VirtualDirectoryNode.createSheet.type.displayName=Kiểu",
        "VirtualDirectoryNode.createSheet.type.desc=Loại hình ảnh.",
        "VirtualDirectoryNode.createSheet.type.text=Tập hợp tập tin Logical",
        "VirtualDirectoryNode.createSheet.timezone.name=Timezone",
        "VirtualDirectoryNode.createSheet.timezone.displayName=Múi giờ",
        "VirtualDirectoryNode.createSheet.timezone.desc=Múi giờ của hình ảnh",
        "VirtualDirectoryNode.createSheet.deviceId.name=Device ID",
        "VirtualDirectoryNode.createSheet.deviceId.displayName=ID thiết bị",
        "VirtualDirectoryNode.createSheet.deviceId.desc=ID thiết bị của hình ảnh"})
