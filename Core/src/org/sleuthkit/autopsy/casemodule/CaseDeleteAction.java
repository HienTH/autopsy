...
final class CaseDeleteAction extends CallableSystemAction {
    ...
    @Override
    @Messages({
        "Case.deleteCaseConfirmationDialog.title=Xóa hồ sơ hiện tại?",
        "Case.deleteCaseConfirmationDialog.message=Bạn có chắc chắn muốn đóng và xóa hồ sơ hiện tại?",
        "Case.deleteCaseFailureMessageBox.title=Không thể Xóa hồ sơ",
        "# {0} - exception message", "Case.deleteCaseFailureMessageBox.message=Lỗi khi xóa hồ sơ: {0}",})
