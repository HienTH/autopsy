 ...
 */
@ActionRegistration(displayName = "Thoát", iconInMenu = true)
...
final public class ExitAction implements ActionListener {
    ...
    @NbBundle.Messages({
        "ExitAction.confirmationDialog.title=Điều tra đang chạy",
        "ExitAction.confirmationDialog.message=Đang điều tra, bạn có chắc chắn muốn thoát không?",
        "# {0} - exception message", "ExitAction.messageBox.caseCloseExceptionMessage=Lỗi khi đóng hồ sơ: {0}"
    })
    @Override
