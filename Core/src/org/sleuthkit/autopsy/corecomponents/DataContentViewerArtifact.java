...
public class DataContentViewerArtifact extends javax.swing.JPanel implements DataContentViewer {
    ...
    @NbBundle.Messages({
        ...
        "DataContentViewerArtifact.failedToGetSourcePath.message=Không thể lấy đường dẫn tệp nguồn từ cơ sở dữ liệu của hồ sơ",
        "DataContentViewerArtifact.failedToGetAttributes.message=Không thể lấy được một số hoặc tất cả các thuộc tính từ cơ sở dữ liệu của hồ sơ"
    })
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pageLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(18, 18, 18)
                .addComponent(pageLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
