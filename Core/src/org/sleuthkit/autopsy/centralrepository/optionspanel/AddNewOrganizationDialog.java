...
public class AddNewOrganizationDialog extends javax.swing.JDialog {
     ...
     */
    @Messages({"AddNewOrganizationDialog.addNewOrg.msg=Thêm tổ chức mới"})
     ...
     * @return True or false.
     */
    @Messages({"AddNewOrganizationDialog.validation.incompleteFields=Tên tổ chức là bắt buộc."})
    ...
    @Messages({"AddNewOrganizationDialog.bnOk.addFailed.text=Không thể thêm tổ chức mới."})
