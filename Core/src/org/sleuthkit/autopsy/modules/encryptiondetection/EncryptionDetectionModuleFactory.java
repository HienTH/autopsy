...
@Messages({
    "EncryptionDetectionFileIngestModule.moduleName.text=Phát hiện Mã hóa",
    "EncryptionDetectionFileIngestModule.getDesc.text=Tìm các tệp tin với entropy tối thiểu được chỉ định."
})
