...
final class AddRawImageTask implements Runnable {
     ...
     */
    @Messages({"AddRawImageTask.progress.add.text=Thêm hình ảnh thô: ",
               "AddRawImageTask.image.critical.error.adding=Thêm lỗi quan trọng ",
               "AddRawImageTask.for.device=cho thiết bị ",
               "AddRawImageTask.image.notExisting=không tồn tại.",
               "AddRawImageTask.image.noncritical.error.adding=Thêm lỗi không quan trọng "})
