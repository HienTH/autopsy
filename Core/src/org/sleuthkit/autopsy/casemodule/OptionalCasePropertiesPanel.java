...
final class OptionalCasePropertiesPanel extends javax.swing.JPanel {
    ...
    @Messages({"OptionalCasePropertiesPanel.caseDisplayNameLabel.text=Tên:",
        "OptionalCasePropertiesPanel.lbPointOfContactEmailLabel.text=Email:",
        "OptionalCasePropertiesPanel.lbOrganizationNameLabel.text=Tổ chức phân tích đang được thực hiện cho:",
        "OptionalCasePropertiesPanel.bnNewOrganization.text=Manage Tổ chức",
        "OptionalCasePropertiesPanel.lbPointOfContactNameLabel.text=Điểm liên hệ:",
        "OptionalCasePropertiesPanel.lbPointOfContactPhoneLabel.text=Điện thoại:",
        "OptionalCasePropertiesPanel.orgainizationPanel.border.title=Tổ chức",
        "OptionalCasePropertiesPanel.lbNotesLabel.text=Ghi chú:",
        "OptionalCasePropertiesPanel.examinerLabel.text=Tên:",
        "OptionalCasePropertiesPanel.lbExaminerEmailLabel.text=Email:",
        "OptionalCasePropertiesPanel.lbExaminerPhoneLabel.text=Điện thoại:",
        "OptionalCasePropertiesPanel.examinerPanel.border.title=Điều tra viên",
        "OptionalCasePropertiesPanel.caseNumberLabel.text=Số:",
        "OptionalCasePropertiesPanel.casePanel.border.title=Hồ sơ"
    })
    /**
    ...
    @Messages({
        "OptionalCasePropertiesPanel.errorDialog.emptyCaseNameMessage=Không có hồ sơ nào được nhập.",
        "OptionalCasePropertiesPanel.errorDialog.invalidCaseNameMessage=Tên hồ sơ không thể bao gồm các ký hiệu sau: \\\\, /, :, *, ?, \", <, >, |"
    })
