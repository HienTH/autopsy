...
class DateSearchFilter extends AbstractFileSearchFilter<DateSearchPanel> {
    ...
    @Override
    @Messages ({
        "DateSearchFilter.errorMessage.endDateBeforeStartDate=Ngày kết thúc phải sau ngày bắt đầu.",
        "DateSearchFilter.errorMessage.noCheckboxSelected=Phải chọn ít nhất một loại ngày."
    })
