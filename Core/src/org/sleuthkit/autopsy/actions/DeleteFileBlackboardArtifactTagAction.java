 ...
 */
@NbBundle.Messages({
    "DeleteFileBlackboardArtifactTagAction.deleteTag=Xóa Thẻ Kết quả"
})
public class DeleteFileBlackboardArtifactTagAction extends AbstractAction implements Presenter.Popup {
    ...
    @NbBundle.Messages({"# {0} - artifactID",
        "DeleteFileBlackboardArtifactTagAction.deleteTag.alert=Không thể bỏ gắn thẻ artifact {0}."})
     ...
     */
    @NbBundle.Messages({"# {0} - artifactID",
        "DeleteFileBlackboardArtifactTagAction.deleteTags.alert=Không thể bỏ gắn thẻ artifact {0}."})
