...
@Messages({"TagNameDialog.descriptionLabel.text=Mô tả:",
    "TagNameDialog.notableCheckbox.text=Thẻ cho biết mục là cần chú ý."})
final class TagNameDialog extends javax.swing.JDialog {
    ...
    @Messages({"TagNameDialog.editTitle.text=Chỉnh sửa thẻ"})
     ...
     */
    @Messages({"TagNameDialog.JOptionPane.tagDescriptionIllegalCharacters.message=Thẻ mô tả không được chứa dấu phẩy (,) hoặc dấu chấm phẩy (;)",
        "TagNameDialog.JOptionPane.tagDescriptionIllegalCharacters.title=Ký tự không hợp lệ trong thẻ mô tả"})
