...
public class ImageFilePanel extends JPanel implements DocumentListener {
    ...
    @NbBundle.Messages({"ImageFilePanel.000.confirmationMessage=Tập tin đã chọn"
        + " có phần mở rộng .001 nhưng có tệp .000 trong chuỗi hình ảnh thô."
        + "\nNên sử dụng tệp .000 đầu tiên, thay vì chọn tệp .001?\n"})
     ...
     */
    @NbBundle.Messages("DataSourceOnCDriveError.text=Cảnh báo: Đường dẫn đến thư mục hồ sơ của đa người dùng nằm trên ổ đĩa \"C:\"")
     ...
     *
     */
    @NbBundle.Messages({"ImageFilePanel.moduleErr=Lỗi Module",
        "ImageFilePanel.moduleErr.msg=Một module đã gây ra lỗi khi nghe cập nhật của ImageFilePanel."
        + " Xem nhật ký để xác định module nào. Một số dữ liệu có thể không đầy đủ.\n"})
