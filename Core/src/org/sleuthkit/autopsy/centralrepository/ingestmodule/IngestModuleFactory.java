...
@NbBundle.Messages({"IngestModuleFactory.ingestmodule.name=Phương tiện tương quan",
                    "IngestModuleFactory.ingestmodule.desc=Lưu thuộc tính vào kho trung tâm cho các tương quan sau"})
