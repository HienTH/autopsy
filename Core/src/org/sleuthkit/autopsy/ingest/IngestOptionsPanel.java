...
public class IngestOptionsPanel extends IngestModuleGlobalSettingsPanel implements OptionsPanel {
    ...
    @NbBundle.Messages({"IngestOptionsPanel.settingsTab.text=Cài đặt",
        "IngestOptionsPanel.settingsTab.toolTipText=Cài đặt tài nguyên sẵn có liên quan đến điều tra.",
        "IngestOptionsPanel.fileFiltersTab.text=Bộ lọc tệp",
        "IngestOptionsPanel.fileFiltersTab.toolTipText=Cài đặt để tạo và chỉnh sửa bộ lọc tập tin.",
        "IngestOptionsPanel.profilesTab.text=Hồ sơ",
        "IngestOptionsPanel.profilesTab.toolTipText=Cài đặt để tạo và chỉnh sửa hồ sơ."})
