...
public final class ViewFileInTimelineAction extends AbstractAction {
    ...
    @NbBundle.Messages({"ViewFileInTimelineAction.viewFile.displayName=Xem Tệp trong Dòng thời gian... "})
    ...
    @NbBundle.Messages({"ViewFileInTimelineAction.viewSourceFile.displayName=Xem tệp nguồn trong Dòng thời gian... "})
