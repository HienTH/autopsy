...
public final class IngestJobSettingsPanel extends javax.swing.JPanel {
    ...
    @Messages({"IngestJobSettingsPanel.noPerRunSettings=Module đã chọn không có cài đặt cho mỗi lần chạy."})
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButtonDeselectAll, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addComponent(fileIngestFilterLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(4, 4, 4)
    ...
    @Messages({"IngestJobSettingsPanel.pastJobsButton.action.frame.title=Lịch sử điều tra"})
     ...
     * descriptions.
     */
    @Messages({"IngestJobSettingsPanel.IngestModulesTableRenderer.warning.message=Module điều tra này đã được chạy trước trên nguồn dữ liệu này.",
        "IngestJobSettingsPanel.IngestModulesTableRenderer.info.message=Một phiên bản trước của module điều tra này đã được chạy trước trên nguồn dữ liệu này."})
