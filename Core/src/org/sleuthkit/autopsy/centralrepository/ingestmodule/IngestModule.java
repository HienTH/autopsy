 ...
 */
@Messages({"IngestModule.prevTaggedSet.text=Thẻ trước được gán là đáng chú ý (Kho trung tâm)",
    "IngestModule.prevCaseComment.text=Hồ sơ trước: "})
class IngestModule implements FileIngestModule {
     ...
     */
    @Messages({"IngestModule.postToBB.fileName=Tên tập tin",
        "IngestModule.postToBB.md5Hash=Mã MD5",
        "IngestModule.postToBB.hashSetSource=Nguồn của bộ Băm",
        "IngestModule.postToBB.eamHit=Kho trung tâm",
        "# {0} - Tên tệp đáng chú ý",
        "IngestModule.postToBB.knownBadMsg=Đáng chú ý: {0}"})
