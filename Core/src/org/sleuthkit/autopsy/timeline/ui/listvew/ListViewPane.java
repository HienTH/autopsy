...
public class ListViewPane extends AbstractTimeLineView {
    ...
    private class ListUpdateTask extends ViewRefreshTask<Interval> {
        ...
        @NbBundle.Messages({
            "ListViewPane.loggedTask.queryDb=Truy xuất dữ liệu sự kiện",
            "ListViewPane.loggedTask.name=Đang cập nhật chế độ xem danh sách",
            "ListViewPane.loggedTask.updateUI=Xem populating"})
        ListUpdateTask() {
