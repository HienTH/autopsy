...
public class EamDbSettingsDialog extends JDialog {
     ...
     */
    @Messages({"EamDbSettingsDialog.title.text=Cấu hình cơ sở dữ liệu kho trung tâm",
        "EamDbSettingsDialog.lbSingleUserSqLite.text=SQLite chỉ nên được sử dụng bởi một điều tra tại một thời điểm.",
        "EamDbSettingsDialog.lbDatabaseType.text=Loại cơ sở dữ liệu :",
        "EamDbSettingsDialog.fcDatabasePath.title=Chọn vị trí cho central_repository.db"})
    ...
    @Messages({"EamDbSettingsDialog.chooserPath.failedToGetDbPathMsg=Đường dẫn cơ sở dữ liệu đã chọn không hợp lệ. Thử lại."})
    ...
    @Messages({"EamDbSettingsDialog.okButton.createDbError.title=Không thể tạo cơ sở dữ liệu",
        "EamDbSettingsDialog.okButton.createSQLiteDbError.message=Không thể tạo Cơ sở dữ liệu SQLite, vui lòng đảm bảo vị trí tồn tại và bạn có quyền ghi và thử lại.",
        "EamDbSettingsDialog.okButton.createPostgresDbError.message=Không thể tạo Cơ sở dữ liệu Postgres, vui lòng đảm bảo địa chỉ, cổng và thông tin đăng nhập chính xác cho máy chủ Postgres và thử lại."})
    ...
    @Messages({"EamDbSettingsDialog.okButton.errorTitle.text=Khởi động lại là bắt buộc.",
        "EamDbSettingsDialog.okButton.errorMsg.text=Vui lòng khởi động lại Autopsy để bắt đầu sử dụng nền tảng cơ sở dữ liệu mới.",
        "EamDbSettingsDialog.okButton.connectionErrorMsg.text=Không thể kết nối với cơ sở dữ liệu kho trung tâm.",
        "EamDbSettingsDialog.okButton.corruptDatabaseExists.title=Lỗi khi tải dữ liệu",
        "EamDbSettingsDialog.okButton.corruptDatabaseExists.message=Cơ sở dữ liệu tồn tại nhưng không đúng định dạng. Xóa bằng tay hoặc chọn một đường dẫn khác (nếu có).",
        "EamDbSettingsDialog.okButton.createDbDialog.title=Cơ sở dữ liệu không tồn tại",
        "EamDbSettingsDialog.okButton.createDbDialog.message=Cơ sở dữ liệu không tồn tại, bạn có muốn tạo nó?",
        "EamDbSettingsDialog.okButton.databaseConnectionFailed.title=Kết nối cơ sở dữ liệu không thành công",
        "EamDbSettingsDialog.okButton.databaseConnectionFailed.message=Không thể kết nối với cơ sở dữ liệu hãy kiểm tra cài đặt của bạn và thử lại."})
     ...
     */
    @Messages({"EamDbSettingsDialog.textPrompt.hostnameOrIP=Tên máy chủ hoặc địa chỉ IP",
        "EamDbSettingsDialog.textPrompt.port=Số cổng",
        "EamDbSettingsDialog.textPrompt.dbName=Tên cơ sở dữ liệu",
        "EamDbSettingsDialog.textPrompt.user=Người dùng cơ sở dữ liệu",
        "EamDbSettingsDialog.textPrompt.password=Mật khẩu của người sử dụng cơ sở dữ liệu"})
     ...
     */
    @Messages({"EamDbSettingsDialog.validation.incompleteFields=Điền vào tất cả giá trị cho cơ sở dữ liệu đã chọn."})
     ...
     * @return true
     */
    @Messages({"EamDbSettingsDialog.validation.finished=Nhấn OK để lưu cài đặt cơ sở dữ liệu của bạn và trở về Options. Hoặc chọn một loại cơ sở dữ liệu khác."})
