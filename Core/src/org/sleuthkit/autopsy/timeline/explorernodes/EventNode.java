...
public class EventNode extends DisplayableItemNode {
    ...
    @Override
    @NbBundle.Messages({
        "EventNode.getAction.errorTitle=Lỗi khi nhận hành động",
        "EventNode.getAction.linkedFileMessage=Đã xảy ra sự cố khi nhận các hành động cho kết quả đã chọn. "
        + " Hành động 'Xem tệp trong Dòng thời gian' sẽ không có sẵn."})
