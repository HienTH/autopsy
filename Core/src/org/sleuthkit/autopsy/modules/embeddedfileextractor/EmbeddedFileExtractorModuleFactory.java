 ...
 */
@NbBundle.Messages({
    "EmbeddedFileExtractorIngestModule.ArchiveExtractor.moduleName=Trình trích xuất tệp nhúng",
    "EmbeddedFileExtractorIngestModule.ArchiveExtractor.moduleDesc.text=Giải nén các tệp nhúng (doc, docx, ppt, pptx, xls, xlsx, zip, rar, arj, 7z, gzip, bzip2, tar)."
})
