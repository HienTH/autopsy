...
@Messages({
    "DirectoryTreeTopComponent.resultsView.title=Danh sách"
})
public final class DirectoryTreeTopComponent extends TopComponent implements DataExplorer, ExplorerManager.Provider {
     ...
     * @param newNodes
     */
    @NbBundle.Messages("DirectoryTreeTopComponent.emptyMimeNode.text=Dữ liệu không tồn tại. Khởi động module nhận dạng tập tin.")
