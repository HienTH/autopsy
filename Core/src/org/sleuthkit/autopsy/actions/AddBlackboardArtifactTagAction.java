 ...
 */
@NbBundle.Messages({
    "AddBlackboardArtifactTagAction.singularTagResult=Thẻ kết quả",
    "AddBlackboardArtifactTagAction.pluralTagResult=Thẻ kết quả",
    "# {0} - artifactName",
    "AddBlackboardArtifactTagAction.unableToTag.msg=Unable to tag {0}.",
    "AddBlackboardArtifactTagAction.taggingErr=Lỗi gắn thẻ"
})
