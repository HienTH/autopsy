...
public final class ManageOrganizationsDialog extends JDialog {
    ...
    @Messages({"ManageOrganizationsDialog.title.text=Quản lý tổ chức"})
    /**
    ...
    @Messages({"ManageOrganizationsDialog.pocNameLabel.text=Điểm Tên Người Liên Hệ:",
        "ManageOrganizationsDialog.deleteButton.text=Xóa bỏ",
        "ManageOrganizationsDialog.newButton.text=Mới",
        "ManageOrganizationsDialog.closeButton.text=Đóng",
        "ManageOrganizationsDialog.orgNameLabel.text=Tên tổ chức:",
        "ManageOrganizationsDialog.pocEmailLabel.text=Điểm liên hệ Email:",
        "ManageOrganizationsDialog.editButton.text=Chỉnh sửa",
        "ManageOrganizationsDialog.pocPhoneLabel.text=Điểm điện thoại liên lạc:",
        "ManageOrganizationsDialog.orgDescriptionTextArea.text=Các tổ chức được sử dụng để cung cấp thông tin liên lạc bổ sung cho nội dung họ được kết hợp với.",
        "ManageOrganizationsDialog.orgListLabel.text=Tổ chức",
        "ManageOrganizationsDialog.orgDetailsLabel.text=Chi tiết về tổ chức",
        "ManageOrganizationsDialog.confirmDeletion.title=Xác nhận xóa",
        "ManageOrganizationsDialog.confirmDeletion.message=Bạn có chắc chắn muốn xóa tổ chức đã chọn khỏi kho trung tâm?",
        "ManageOrganizationsDialog.unableToDeleteOrg.title=Không thể xóa",
        "ManageOrganizationsDialog.unableToDeleteOrg.message=Không thể xóa tổ chức đã chọn."})
    /**
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(manageOrganizationsScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 661, Short.MAX_VALUE))
        );
