...
public class ViewContextAction extends AbstractAction {
    ...
    @Override
    @Messages({
        "ViewContextAction.errorMessage.cannotFindDirectory=Không tìm được thư mục.",
        "ViewContextAction.errorMessage.cannotSelectDirectory=Không thể chọn thư mục trong cây.",})
