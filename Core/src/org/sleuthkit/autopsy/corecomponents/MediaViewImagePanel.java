 ...
 * image.
 */
@NbBundle.Messages({"MediaViewImagePanel.externalViewerButton.text=Mở trong Trình xem bên ngoài",
    "MediaViewImagePanel.errorLabel.text=Không thể tải tệp vào Chế độ xem Media.",
    "MediaViewImagePanel.errorLabel.OOMText=Không thể tải tệp vào Chế độ xem Media: bộ nhớ không đủ."})
