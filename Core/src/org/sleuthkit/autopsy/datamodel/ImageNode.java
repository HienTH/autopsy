...
public class ImageNode extends AbstractContentNode<Image> {
     ...
     */
    @Override
    @Messages({"ImageNode.action.runIngestMods.text=Chạy Module điều tra",
        "ImageNode.getActions.openFileSearchByAttr.text=Mở tìm kiếm tập tin theo thuộc tính",})
    ...
    @Messages({"ImageNode.createSheet.size.name=Size (Bytes)",
        "ImageNode.createSheet.size.displayName=Kích thước (Bytes)",
        "ImageNode.createSheet.size.desc=Kích thước của nguồn dữ liệu theo byte.",
        "ImageNode.createSheet.type.name=Type",
        "ImageNode.createSheet.type.displayName=Kiểu",
        "ImageNode.createSheet.type.desc=Loại hình ảnh.",
        "ImageNode.createSheet.type.text=Image",
        "ImageNode.createSheet.sectorSize.name=Sector Size (Bytes)",
        "ImageNode.createSheet.sectorSize.displayName=Kích thước Sector (Bytes)",
        "ImageNode.createSheet.sectorSize.desc=Kích thước của ảnh theo byte.",
        "ImageNode.createSheet.md5.name=MD5 Hash",
        "ImageNode.createSheet.md5.displayName=Mã MD5",
        "ImageNode.createSheet.md5.desc=Mã MD5 của hình ảnh",
        "ImageNode.createSheet.timezone.name=Timezone",
        "ImageNode.createSheet.timezone.displayName=Múi giờ",
        "ImageNode.createSheet.timezone.desc=Múi giờ của hình ảnh",
        "ImageNode.createSheet.deviceId.name=Device ID",
        "ImageNode.createSheet.deviceId.displayName=ID thiết bị",
        "ImageNode.createSheet.deviceId.desc=ID thiết bị của hình ảnh"})
