...
final class MultiUserNode extends AbstractNode {
    ...
    @Messages({"CaseNode.column.name=Tên",
        "CaseNode.column.createdTime=Thời gian tạo",
        "CaseNode.column.metadataFilePath=Đường dẫn"})
    ...
    @Messages({"MultiUserNode.OpenMultiUserCaseAction.text=Mở hồ sơ"})
    /**
    ...
    @Messages({"MultiUserNode.OpenCaseLogAction.text=Mở tập tin nhật ký"})
    /**
     * An action that opens the specified case and hides the multi user case
     * panel.
     */
