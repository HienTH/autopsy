 ...
 */
@NbBundle.Messages({
    "CannotCreateOutputFolder=Không thể tạo thư mục đầu ra.",
    "CannotRunFileTypeDetection=Không thể chạy phát hiện loại tệp.",
    "UnableToInitializeLibraries=Không thể khởi tạo thư viện 7zip."
})
