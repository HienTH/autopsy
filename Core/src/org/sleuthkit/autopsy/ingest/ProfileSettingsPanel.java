...
class ProfileSettingsPanel extends IngestModuleGlobalSettingsPanel implements OptionsPanel {
    ...
    @NbBundle.Messages({"ProfileSettingsPanel.title=Cài đặt cấu hình",
        "ProfileSettingsPanel.profileListLabel.text=Tiểu sử:",
        "ProfileSettingsPanel.profileDescLabel.text=Mô tả tiểu sử:",
        "ProfileSettingsPanel.filterNameLabel.text=Bộ lọc:",
        "ProfileSettingsPanel.selectedModulesLabel.text=Module điều tra được chọn:",
        "ProfileSettingsPanel.newProfileButton.text=Tiểu sử mới",
        "ProfileSettingsPanel.editProfileButton.text=Sửa tiểu sử",
        "ProfileSettingsPanel.deleteProfileButton.text=Xóa tiểu sử",
        "ProfileSettingsPanel.messages.filterLoadFailed=Không thể tải bộ lọc tệp",
        "# {0} - profile name",
        "ProfileSettingsPanel.doFileSetsDialog.duplicateProfile.text=Tiểu sử có tên {0} đã tồn tại.",
        "ProfileSettingsPanel.infoTextArea.text=Một tiểu sử điều tra chạy một modle đã được cấu hình sẵn"
        + " trên một số hoặc tất cả các tệp trong một nguồn dữ liệu. Tạo một hồ sơ nếu bạn thường xuyên chạy cùng một tập các module trên tập con của các tệp tin."
    })
