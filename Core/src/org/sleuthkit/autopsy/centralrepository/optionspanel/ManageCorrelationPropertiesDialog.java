...
final class ManageCorrelationPropertiesDialog extends javax.swing.JDialog {
     ...
     */
    @Messages({"ManageCorrelationPropertiesDialog.title=Quản lý Thuộc tính Tương quan"})
    ...
    @Messages({"ManageCorrelationPropertiesDialog.noneSelected=Tính chất tương quan không được bật."})
    ...
    @Messages({"ManageCorrelationPropertiesDialog.okbutton.failure=Lỗi khi lưu các lựa chọn đã cập nhật."})
