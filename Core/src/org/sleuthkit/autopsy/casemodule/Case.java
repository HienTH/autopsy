...
public class Case {
    ...
    public enum CaseType {
         ...
         */
        @Messages({
            "Case_caseType_singleUser=Hồ sơ đơn người dùng",
            "Case_caseType_multiUser=Hồ sơ nhiều người dùng"
        })
     ...
     */
    @Messages({
        "Case.exceptionMessage.emptyCaseName=Phải ghi rõ tên hồ sơ.",
        "Case.exceptionMessage.emptyCaseDir=Phải chỉ định đường dẫn thư mục hồ sơ."
    })
     ...
     */
    @Messages({
        "Case.exceptionMessage.failedToReadMetadata=Không thể đọc siêu dữ liệu của hồ sơ.",
        "Case.exceptionMessage.cannotOpenMultiUserCaseNoSettings=Cài đặt đa người dùng bị thiếu (xem Công cụ, Tùy chọn, tab Đa người dùng), không thể mở một hồ sơ nhiều người dùng"
    })
     ...
     */
    @Messages({
        "# {0} - exception message", "Case.closeException.couldNotCloseCase=Lỗi khi kết thúc hồ sơ: {0}",
        "Case.progressIndicatorTitle.closingCase=Đóng hồ sơ"
    })
     ...
     */
    @Messages({
        "Case.progressIndicatorTitle.deletingCase=Xóa hồ sơ",
        "Case.exceptionMessage.cannotDeleteCurrentCase=Không thể xóa hồ sơ hiện tại, nó phải được đóng trước tiên.",
        "Case.progressMessage.checkingForOtherUser=Kiểm tra để xem người dùng khác có hồ sơ mở...",
        "Case.exceptionMessage.cannotGetLockToDeleteCase=Không thể xóa hồ sơ vì nó được mở cho người dùng khác hoặc có vấn đề với dịch vụ phối hợp."
    })
     ...
     */
    @Messages({
        "Case.exceptionMessage.cannotLocateMainWindow=Không thể định vị cửa sổ ứng dụng"
    })
     ...
     */
    @Messages({
        "Case.progressMessage.deletingTextIndex=Xóa chỉ mục văn bản ...",
        "Case.progressMessage.deletingCaseDatabase=Xóa cơ sở dữ liệu cho trường hợp...",
        "Case.progressMessage.deletingCaseDirectory=Xóa đưòng dẫn thư mục cho trường hợp...",
        "Case.exceptionMessage.errorsDeletingCase=Lỗi xảy ra trong khi xóa hồ sơ. Xem nhật ký ứng dụng để biết chi tiết"
    })
     ...
     *                             cannot be acquired.
     */
    @Messages({"Case.creationException.couldNotAcquireResourcesLock=Không thể khóa tài nguyên của hồ sơ"})
     ...
     */
    @Messages({
        "Case.exceptionMessage.metadataUpdateError=Không thể cập nhật siêu dữ liệu của hồ sơ"
    })
     ...
     */
    @Messages({
        "Case.progressIndicatorTitle.creatingCase=Tạo hồ sơ",
        "Case.progressIndicatorTitle.openingCase=Mở hồ sơ",
        "Case.progressIndicatorCancelButton.label=Hủy",
        "Case.progressMessage.preparing=Chuẩn bị...",
        "Case.progressMessage.preparingToOpenCaseResources=<html>Chuẩn bị mở các tài nguyên trường hợp.<br>Quá trình này có thể mất thời gian nếu người dùng khác đang nâng cấp trường hợp.</html>",
        "Case.progressMessage.cancelling=Đang hủy...",
        "Case.exceptionMessage.cancelledByUser=Đã hủy bởi người dùng.",
     ...
     */
    @Messages({
        "Case.progressMessage.creatingCaseDirectory=Tạo thư mục hồ sơ...",
        "Case.progressMessage.creatingCaseDatabase=Tạo cơ sở dữ liệu cho hồ sơ...",
        "# {0} - exception message", "Case.exceptionMessage.couldNotCreateCaseDatabase=Không thể tạo cơ sở dữ liệu cho hồ sơ:\n{0}",
        "Case.exceptionMessage.couldNotCreateMetadataFile=Không thể tạo tệp siêu dữ liệu cho hồ sơ."
    })
     ...
     */
    @Messages({
        "Case.progressMessage.openingCaseDatabase=Mở cơ sở dữ liệu của hồ sơ...",
        "Case.exceptionMessage.couldNotOpenCaseDatabase=Không thể mở cơ sở dữ liệu của hồ sơ.",
        "Case.unsupportedSchemaVersionMessage=Phiên bản lược đồ cơ sở dữ liệu không được hỗ trợ - xem nhật ký để biết chi tiết",
        "Case.databaseConnectionInfo.error.msg=Lỗi khi truy cập thông tin kết nối máy chủ cơ sở dữ liệu. Xem Công cụ, Tùy chọn, Đa người dùng.",
        "Case.open.exception.multiUserCaseNotEnabled=Không thể mở một hồ sơ nhiều người dùng nếu hồ sơ nhiều người dùng không được bật. "
        + "Xem Công cụ, Tùy chọn, Đa Người dùng."
    })
     ...
     */
    @Messages({
        "Case.progressMessage.switchingLogDirectory=Đang chuyển đổi thư mục nhật ký...",
        "Case.progressMessage.clearingTempDirectory=Đang xóa thư mục tạm thời của hồ sơ...",
        "Case.progressMessage.openingCaseLevelServices=Mở các dịch vụ cấp hồ sơ...",
        "Case.progressMessage.openingApplicationServiceResources=Mở tài nguyên hồ sơ của dịch vụ ứng dụng...",
        "Case.progressMessage.settingUpNetworkCommunications=Thiết lập mạng truyền thông...",})
     ...
     */
    @NbBundle.Messages({
        "# {0} - service name", "Case.serviceOpenCaseResourcesProgressIndicator.title={0} Mở Tài nguyên Hồ sơ",
        "# {0} - service name", "Case.serviceOpenCaseResourcesProgressIndicator.cancellingMessage=Hủy mở hồ sơ bằng {0}...",
        "# {0} - service name", "Case.servicesException.notificationTitle={0} Lỗi"
    })
     ...
     */
    @Messages({
        "Case.progressMessage.shuttingDownNetworkCommunications=Tắt truyền thông mạng...",
        "Case.progressMessage.closingApplicationServiceResources=Đóng tài nguyên ứng dụng dịch vụ theo hồ sơ cụ thể...",
        "Case.progressMessage.closingCaseLevelServices=Đóng các dịch vụ cấp hồ sơ...",
        "Case.progressMessage.closingCaseDatabase=Đóng cơ sở dữ liệu của hồ sơ..."
    })
     ...
     */
    @Messages({
        "# {0} - serviceName", "Case.serviceCloseResourcesProgressIndicator.title={0} Đóng cơ sở dữ liệu của hồ sơ",
        "# {0} - service name", "# {1} - exception message", "Case.servicesException.serviceResourcesCloseError=Không thể đóng tài nguyên hồ sơ cho {0} dịch vụ: {1}"
    })
     ...
     *                             cannot be acquired.
     */
    @Messages({"Case.creationException.couldNotAcquireDirLock=Không thể khóa thư mục hồ sơ."})
