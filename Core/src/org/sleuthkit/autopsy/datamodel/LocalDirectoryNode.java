...
public class LocalDirectoryNode extends SpecialDirectoryNode {
    ...
    @NbBundle.Messages({
        ...
        "LocalDirectoryNode.createSheet.name.displayName=Tên",
        "LocalDirectoryNode.createSheet.name.desc=Không có mô tả",
        "LocalDirectoryNode.createSheet.noDesc=Không có mô tả"})
