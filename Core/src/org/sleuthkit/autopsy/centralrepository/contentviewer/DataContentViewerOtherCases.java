...
@Messages({"DataContentViewerOtherCases.title=Các lần xuất hiện khác",
    "DataContentViewerOtherCases.toolTip=Hiển thị các thể hiện của tệp tin/thành phần lạ đã chọn từ các lần xuất hiện khác.",})
public class DataContentViewerOtherCases extends javax.swing.JPanel implements DataContentViewer {
    ...
    @Messages({"DataContentViewerOtherCases.correlatedArtifacts.isEmpty=Không có tệp hoặc hiện vật nào tương quan.",
        "# {0} - commonality percentage",
        "# {1} - correlation type",
        "# {2} - correlation value",
        "DataContentViewerOtherCases.correlatedArtifacts.byType={0}% của nguồn dữ liệu có {2} (kiểu: {1})\n",
        "DataContentViewerOtherCases.correlatedArtifacts.title=Thuộc tính Tần số",
        "DataContentViewerOtherCases.correlatedArtifacts.failed=Không thể nhận được chi tiết tần số."})
    /**
    ...
    @Messages({"DataContentViewerOtherCases.caseDetailsDialog.notSelected=Không có hàng nào được chọn",
        "DataContentViewerOtherCases.caseDetailsDialog.noDetails=Không có chi tiết cho hồ sơ này.",
        "DataContentViewerOtherCases.caseDetailsDialog.noDetailsReference=Không có chi tiết hồ sơ cho thuộc tính tham khảo nội bộ.",
        "DataContentViewerOtherCases.caseDetailsDialog.noCaseNameError=Lỗi"})
    ...
    @Override
    @Messages({"DataContentViewerOtherCases.table.nodbconnection=Không thể kết nối với cơ sở dữ liệu kho trung tâm."})
     ...
     */
    @Messages({"DataContentViewerOtherCases.table.isempty=Không có hiện vật hoặc tệp tin liên quan từ các lần xuất hiện khác để hiển thị.",
        "DataContentViewerOtherCases.table.noArtifacts=Tương quan không thể được thực hiện trên tệp được chọn."})
