...
final class ExtractUnallocAction extends AbstractAction {
    ...
    @NbBundle.Messages({"# {0} - fileName",
            "ExtractUnallocAction.volumeInProgress=Đã giải nén không gian chưa được gán vào {0} - sẽ bỏ qua ổ đĩa này",
            "ExtractUnallocAction.volumeError=Lỗi khi giải nén không gian chưa phân bổ từ ổ đĩa",
            "ExtractUnallocAction.noFiles=Không tìm thấy tệp không được định vị trên ổ đĩa",
            "ExtractUnallocAction.imageError=Lỗi khi giải nén không gian phân bổ không được gán từ ảnh ổ đĩa"})
    @Override
