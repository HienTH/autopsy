...
class ProfilePanel extends IngestModuleGlobalSettingsPanel {
    ...
    @NbBundle.Messages({"ProfilePanel.title.text=Hồ sơ",
        "ProfilePanel.profileDescLabel.text=Mô tả:",
        "ProfilePanel.profileNameLabel.text=Tên hồ sơ:",
        "ProfilePanel.newProfileText=NewEmptyProfile",
        "ProfilePanel.messages.profilesMustBeNamed=Hồ sơ điều tra phải có tên.",
        "ProfilePanel.messages.profileNameContainsIllegalCharacter=Tên hồ sơ chứa một ký tự không hợp lệ"})
