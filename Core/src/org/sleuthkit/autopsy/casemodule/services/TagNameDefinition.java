...
final class TagNameDefinition implements Comparable<TagNameDefinition> {
    ...
    @NbBundle.Messages({"TagNameDefinition.predefTagNames.bookmark.text=Đánh dấu",
        "TagNameDefinition.predefTagNames.followUp.text=Theo sát",
        "TagNameDefinition.predefTagNames.notableItem.text=Mục đáng chú ý"})
