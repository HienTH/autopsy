...
final class EventCountsChart extends StackedBarChart<String, Number> implements TimeLineChart<String> {
    ...
    @NbBundle.Messages({
        ...
        "# {2} - start date time",
        "# {3} - end date time",
        "CountsViewPane.tooltip.text={0} {1} sự kiện\ngiữa {2}\nvà    {3}"})
    @Override
    ...
    private class BarClickHandler implements EventHandler<MouseEvent> {
        ...
        @NbBundle.Messages({"Timeline.ui.countsview.menuItem.selectTimeRange=Chọn Khoảng thời gian"})
        ...
        @NbBundle.Messages({"Timeline.ui.countsview.menuItem.selectEventType=Chọn loại sự kiện"})
        ...
        @NbBundle.Messages({"Timeline.ui.countsview.menuItem.selectTimeandType=Chọn Thời gian và Loại"})
        ...
        @NbBundle.Messages({"Timeline.ui.countsview.menuItem.zoomIntoTimeRange=Phóng to Khoảng thời gian"})
        ...
        @Override
        @NbBundle.Messages({
            "CountsViewPane.detailSwitchMessage=Không có độ phân giải thời gian nhỏ hơn Seconds. \\n Bạn có muốn chuyển sang chế độ xem Chi tiết?",
            "CountsViewPane.detailSwitchTitle=\"Chuyển sang chế độ xem chi tiết?"})
