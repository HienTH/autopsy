...
public class IngestManager {
     ...
     */
    @NbBundle.Messages({
        "IngestManager.startupErr.dlgTitle=Không thể khởi động module điều tra",
        "IngestManager.startupErr.dlgMsg=Không thể bắt đầu một hoặc nhiều module, điều tra bị hủy.",
        "IngestManager.startupErr.dlgSolution=Vui lòng vô hiệu các module không thành công hoặc sửa lỗi trước khi khởi động lại.",
        "IngestManager.startupErr.dlgErrorList=Lỗi:"
    })
