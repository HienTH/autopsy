 ...
 */
@NbBundle.Messages({
    "AddContentTagAction.singularTagFile=Tệp tin gắn thẻ",
    "AddContentTagAction.pluralTagFile=Tệp tin gắn thẻ",
    "# {0} - fileName",
    "AddContentTagAction.unableToTag.msg=Không thể gắn thẻ {0}, không phải là tệp thông thường.",
    "AddContentTagAction.cannotApplyTagErr=Cannot Apply Tag",
    "# {0} - fileName",
    "AddContentTagAction.unableToTag.msg2=Không thể gắn thẻ {0}.",
    "AddContentTagAction.taggingErr=Lỗi đính thẻ",
    "# {0} - fileName", "# {1} - tagName",
    "AddContentTagAction.tagExists={0} đã được gắn thẻ là {1}. Không thể áp dụng lại cùng một thẻ."
})
