...
public class ArtifactStringContent implements StringContent {
    ...
    @Messages({
        ...
        "ArtifactStringContent.failedToGetSourcePath.message=Không thể lấy đường dẫn tệp nguồn từ cơ sở dữ liệu của hồ sơ",
        "ArtifactStringContent.failedToGetAttributes.message=Không thể lấy được một số hoặc tất cả các thuộc tính từ cơ sở dữ liệu hồ sơ"
    })
    @Override
