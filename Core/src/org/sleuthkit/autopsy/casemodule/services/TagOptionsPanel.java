...
final class TagOptionsPanel extends javax.swing.JPanel implements OptionsPanel {
    ...
    @Messages({"TagOptionsPanel.panelDescriptionTextArea.text=Tạo và quản lý thẻ. "
        + "Thẻ có thể được áp dụng cho các tệp và kết quả trong hồ sơ. Thẻ đáng chú ý sẽ gây ra "
        + "các mục được gắn thẻ với chúng được gắn cờ là đáng chú ý khi sử dụng kho trung tâm. "
        + "Thay đổi trạng thái của thẻ sẽ chỉ ảnh hưởng đến các mục trong hồ sơ hiện tại.",
        "TagOptionsPanel.ingestRunningWarningLabel.text=Không thể thay đổi các thẻ hiện tại khi đang điều tra!",
        "TagOptionsPanel.descriptionLabel.text=Thẻ mô tả:",
        "TagOptionsPanel.notableYesOrNoLabel.text=",
        "TagOptionsPanel.isNotableLabel.text=Thẻ cho biết mục là đáng chú ý: ",
        "TagOptionsPanel.editTagNameButton.text=Chỉnh sửa thẻ"})
    ...
    @Messages({"TagOptionsPanel.TagNameDialog.tagNameAlreadyExists.message=Tên thẻ phải là duy nhất. Thẻ có tên này đã tồn tại.",
        "TagOptionsPanel.TagNameDialog.tagNameAlreadyExists.title=Tên thẻ trùng lặp"})
