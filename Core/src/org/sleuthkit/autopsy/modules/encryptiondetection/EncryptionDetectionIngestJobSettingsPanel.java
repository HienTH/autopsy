...
final class EncryptionDetectionIngestJobSettingsPanel extends IngestModuleIngestJobSettingsPanel {
     ...
     */
    @Messages({
        "EncryptionDetectionIngestJobSettingsPanel.minimumEntropyInput.validationError.text=Đầu vào entropy tối thiểu phải là một số từ 6,0 đến 8,0."
    })
     ...
     */
    @Messages({
        "EncryptionDetectionIngestJobSettingsPanel.minimumFileSizeInput.validationError.text=Kích thước tệp nhập tối thiểu phải là số nguyên (bằng megabyte) là 1 hoặc lớn hơn."
    })
