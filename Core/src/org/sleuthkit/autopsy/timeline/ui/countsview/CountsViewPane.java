...
public class CountsViewPane extends AbstractTimelineChart<String, Number, Node, EventCountsChart> {
    ...
    @NbBundle.Messages({
        "# {0} - scale name",
        "CountsViewPane.numberOfEvents=Số lượng sự kiện ({0})"})
