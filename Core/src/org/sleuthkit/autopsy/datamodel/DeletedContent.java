...
public class DeletedContent implements AutopsyVisitableItem {
    ...
    @NbBundle.Messages({"DeletedContent.fsDelFilter.text=Hệ thống tập tin",
        "DeletedContent.allDelFilter.text=Tất cả"})
    ...
    public static class DeletedContentsNode extends DisplayableItemNode {
        ...
        @NbBundle.Messages("DeletedContent.deletedContentsNode.name=Tập tin đã xóa")
        ...
        @Override
        @NbBundle.Messages({
            "DeletedContent.createSheet.name.displayName=Tên",
            "DeletedContent.createSheet.name.desc=Không có mô tả"})
    ...
    public static class DeletedContentsChildren extends ChildFactory<DeletedContent.DeletedContentFilter> {
        ...
        public class DeletedContentNode extends DisplayableItemNode {
            ...
            @Override
            @NbBundle.Messages({
                "DeletedContent.createSheet.filterType.displayName=Tên",
                "DeletedContent.createSheet.filterType.desc=Không có mô tả"})
            protected Sheet createSheet() {
                Sheet s = super.createSheet();
                Sheet.Set ss = s.get(Sheet.PROPERTIES);
                if (ss == null) {
        ...
        static class DeletedContentChildren extends ChildFactory.Detachable<AbstractFile> {
            ...
            @NbBundle.Messages({"# {0} - The deleted files threshold",
                ...
                + "Có thể hiển thị được nhiều tệp đã Xóa hơn."
                + " Chỉ có {0} Tệp được Xóa đầu tiên mới được hiển thị."})
